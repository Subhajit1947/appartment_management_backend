...
class TopPostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields=[
            ...
            "upvotes","view_count","replies_count",
            "avatar","created_at"
        ]
...
class ReplySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=Reply
        fields=[
            "id","post","author_username","body","avatar",
...
class BasePostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=Post
        fields=[
            "id","title","slug","author_username","is_bookmarked",
            "created_at","updated_at","view_count","upvotes",
            "downvotes","is_upvoted","replies_count","avatar",

        ]
        read_only_fields=[
            "id","slug","author_username","created_at",
            "updated_at"
        ]
...
class PostSerializers(TaggitSerializer,BasePostSerializer):
