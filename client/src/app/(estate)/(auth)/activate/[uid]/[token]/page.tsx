...
export default function ActivationPage({params}:ActivationProps) {
  ...
  const [activateUser,{isLoading,isError,isSuccess,error}]=useActivateUserMutation()
  useEffect(()=>{
  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <div className="text-center">
        <h3 className='dark:text-pumpkin font-robotoSlab text-2xl font-bold text-gray-800 sm:text-4xl md:text-5xl'>
          {isLoading?(
            <div className="flex-center">
              <span className="mr-2">🕛</span>
              <span>Activating Your account........pls wait</span>
